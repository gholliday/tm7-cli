...
[DataContract(Name = SerializableItemTypes.LineBoundary, Namespace = "http://schemas.datacontract.org/2004/07/ThreatModeling.Model")]
public class SerializableLineBoundary : SerializableLine
{
    public SerializableLineBoundary(Guid guid, string typeId, string genericTypeId,
